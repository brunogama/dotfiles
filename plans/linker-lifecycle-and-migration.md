...
- With `--force --yes`, explicitly accepted unmanaged legacy entries move to a timestamped XDG state backup before migration; the corresponding integration test verifies both backup contents and rerun idempotence.
