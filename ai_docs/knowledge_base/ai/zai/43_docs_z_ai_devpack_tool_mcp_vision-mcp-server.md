# https://docs.z.ai/devpack/tool/mcp/vision-mcp-server

Source: [https://docs.z.ai/devpack/tool/mcp/vision-mcp-server](https://docs.z.ai/devpack/tool/mcp/vision-mcp-server)

---

[Skip to main content](https://docs.z.ai/devpack/tool/mcp/vision-mcp-server#content-area)
...
[Vision MCP Server](https://docs.z.ai/devpack/mcp/vision-mcp-server#vision-mcp-server)[Quick Start](https://docs.z.ai/devpack/quick-start#vision-mcp-server-pro-plan-exclusive)[Claude Code](https://docs.z.ai/scenario-example/develop-tools/claude#vision-and-search-mcp)
⌘I
Assistant
