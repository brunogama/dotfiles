# Generated by Powerlevel10k configuration wizard on 2025-10-11 at 11:18 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    env_context             # environment indicator
  ...
  function prompt_env_context() {
    ...
    if [[ -n ${WORK_ENV:-} ]]; then
      ...
      color=39
    elif [[ -n ${PROMPT_ENVIRONMENT:-} ]]; then
      label="${(U)PROMPT_ENVIRONMENT}"
      color=110
    else
      return
    fi
